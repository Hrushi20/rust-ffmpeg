...
impl<'a> Chapter<'a> {
    ...
    pub fn time_base(&self) -> Rational {
        unsafe {
            ...
            avformat_wasmedge::avChapter_timebase(
                result_num as u32,
                result_den as u32,
                self.ptr(),
                self.index as u32,
    ...
    pub fn start(&self) -> i64 {
        unsafe { avformat_wasmedge::avChapter_start(self.ptr(), self.index as u32) }
    }

    pub fn end(&self) -> i64 {
        unsafe { avformat_wasmedge::avChapter_end(self.ptr(), self.index as u32) }
    }
